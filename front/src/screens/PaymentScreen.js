  ...
  return <FormContainer>
      ...
      <Form onSubmit={submitHandler}>
        <Form.Group>
          ...
          <Col>
            <Form.Check type="radio" label="PayPal ou Cartão de crédito" id="PayPal" name="paymentMethod" 
         ...
         {/*   <Form.Check type="radio" label="Stripe" id="Stripe" name="paymentMethod" 
            value="Stripe" onChange={(e) => setPaymentMethod(e.target.value)}></Form.Check> */}
          </Col>
